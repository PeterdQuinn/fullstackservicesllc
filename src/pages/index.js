    ...
    <Layout>
      ...
      <section id="overview" className="py-20 bg-blue-900 text-white">
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <Image src="/fullstack.png" alt="Full Stack Services LLC" width={500} height={300} className="rounded-lg shadow-lg mx-auto" />
          </div>
        </div>
      </section>
      ...
      <section id="benefits" className="py-20 bg-white text-blue-900">
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <Image src="/Fullstack2.jpeg" alt="Target Business Types" width={500} height={300} className="rounded-lg shadow-lg mx-auto" />
          </div>
        </div>
      </section>

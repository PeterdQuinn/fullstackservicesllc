          ...
          <div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                ...
                <input type="text" id="name" className="w-full p-2 border border-gray-300 rounded-lg" onChange={handleChange} />
              </div>
              <div>
                <label htmlFor="email" className="block text-gray-600">Email</label>
                <input type="email" id="email" className="w-full p-2 border border-blue-300 rounded-lg" onChange={handleChange} />
              </div>
              <div>
                <label htmlFor="message" className="block text-gray-600">Message</label>
                <textarea id="message" className="w-full p-2 border border-gray-300 rounded-lg" rows="4" style={{ color: 'black' }} onChange={handleChange}></textarea>
              </div>
              <button type="submit" className="bg-blue-600 text-gray font-bold py-2 px-4 rounded-lg hover:bg-blue-700">Send Message</button>
            </form>
          </div>
          <div>
